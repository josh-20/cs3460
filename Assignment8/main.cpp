...
void testBoolSpecialization()
{
    ...
    std::cout << std::endl
              << std::endl;
    usu::vector<bool> vector1{ true, true, true, false, false, false, true, false,
                               false, true };
    usu::vector<bool> vector2{ true, true, true, false, false, false, true, false,
                               false, true };
    usu::vector<bool> vector3{ true, true, true, false, false, false, true, false,
                               false, true };
    usu::vector<bool> vector4{ true, true, true, false, false, false, true, false,
                               false, true };
    usu::vector<bool> vector5{ true, true, true, false, false, false, true, false,
                               false, true };
